/* ======================================================================
   ...
   Build: 2026-07-28 v81 full-width report content and enlarged cards
   ====================================================================== */
(function(){
  'use strict';
  ...
  window._grcOpenExcelSelector=function(){
    ...
    EXCEL_FIXED_DEPTS=canViewAll?[]:[reportUserDept()];
    var deptSection='';
    if(canViewAll){
  ...
  window._grcGenerateExcel=async function(){
    var depts=EXCEL_FIXED_DEPTS.length?EXCEL_FIXED_DEPTS:checked('grcExcelDept'),selected=checked('grcExcelRegister');
...
`;doc.appendChild(style);return doc;}
  ...
  function printGrcReportDocument(doc,options){
    try{
      ...
      st.textContent='@media screen{#qumcPrintReportPage{position:fixed!important;left:-100000px!important;top:0!important;width:297mm!important;min-width:297mm!important;visibility:hidden!important;pointer-events:none!important;background:#fff!important}}@media print{@page{size:297mm 210mm!important;margin:0!important}html.grc-print-report-only,body.grc-print-report-only{width:297mm!important;margin:0!important;padding:0!important;background:#fff!important;overflow:visible!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}body.grc-print-report-only>:not(#qumcPrintReportPage){display:none!important}#qumcPrintReportPage{display:block!important;position:static!important;width:297mm!important;min-width:297mm!important;max-width:297mm!important;min-height:210mm!important;margin:0!important;padding:0!important;background:#fff!important;visibility:visible!important;overflow:visible!important;box-sizing:border-box!important}#qumcPrintReportPage .qumc-print-report-sheet,#qumcPrintReportPage #rptDocument,#qumcPrintReportPage .grc-exec-report{display:block!important;width:297mm!important;min-width:297mm!important;max-width:297mm!important;min-height:210mm!important;margin:0!important;padding:0!important;background:#fff!important;transform:none!important;zoom:1!important;box-sizing:border-box!important;overflow:visible!important}}';
  ...
  window._grcGenerateReport=async function(){var items=checked('grcReportItem'),depts=REPORT_FIXED_DEPTS.length?REPORT_FIXED_DEPTS:checked('grcReportDept');if(!items.length){alert('Select at least one report content option.');return;}if(!depts.length){alert('Select at least one department.');return;}var doc=buildExecutiveReport(items,depts);closeOverlay();var period=(depts.length===DEPTS.length?'All Departments':depts.map(departmentTitle).join(', '))+' · '+new Date().toLocaleDateString('en-GB'),ok=false;try{if(typeof window._qumcPrintReportDocument==='function')ok=window._qumcPrintReportDocument(doc,{period:'GRC Executive Summary · '+period,orientation:'landscape'});}catch(_printErr){ok=false;}if(!ok)ok=printGrcReportDocument(doc,{period:'GRC Executive Summary · '+period,orientation:'landscape'});if(ok){var ps=document.getElementById('grc-a4-landscape-override');if(ps)ps.remove();ps=document.createElement('style');ps.id='grc-a4-landscape-override';ps.textContent='@media print{@page{size:297mm 210mm!important;margin:0!important}html,body{width:297mm!important;margin:0!important;padding:0!important;background:#fff!important}#qumcPrintReportPage{width:297mm!important;min-width:297mm!important;max-width:297mm!important;min-height:210mm!important;padding:0!important;margin:0!important;background:#fff!important;display:block!important;box-sizing:border-box!important}#qumcPrintReportPage .qumc-print-report-sheet,#qumcPrintReportPage #rptDocument,#qumcPrintReportPage .grc-exec-report{width:297mm!important;min-width:297mm!important;max-width:297mm!important;min-height:210mm!important;margin:0!important;padding:0!important;transform:none!important;zoom:1!important;background:#fff!important;box-sizing:border-box!important}}@media screen{#qumcPrintReportPage{width:297mm!important;min-width:297mm!important;max-width:297mm!important;padding:0!important;margin:0!important;background:#fff!important;box-sizing:border-box!important}#qumcPrintReportPage .qumc-print-report-sheet,#qumcPrintReportPage #rptDocument,#qumcPrintReportPage .grc-exec-report{width:297mm!important;min-width:297mm!important;max-width:297mm!important;min-height:210mm!important;margin:0!important;padding:0!important;transform:none!important;zoom:1!important;background:#fff!important;box-sizing:border-box!important}}';document.head.appendChild(ps);}if(!ok){alert('Unable to prepare the GRC report for printing. Reload the page and try again.');return;}if(typeof window.addAudit==='function')window.addAudit('GRC_REPORT_PDF','Generated GRC executive summary: '+items.join(', '));};
