...
`;document.head.appendChild(st);
  ...
  var GRC_REQUEST_TYPES=[
    'Access / Permission Request','Role or Permission Update','Page or Module Access','Register Access Request',
    'Data Entry Permission','Approval Workflow Access','Report / Excel / Export Access','System Issue',
    'Feature Enhancement Request','Data Correction Request','General GRC Request','Other'
  ];
