...
<!-- === EXECUTIVE SUMMARY === -->
<div class="c12" style="padding:0;background:transparent;box-shadow:none;border:none;margin-bottom:14px">
  <div id="execIntelBar" style="background:#192835;border:1px solid #3A5063;border-radius:14px;padding:0;box-shadow:0 4px 24px rgba(10,22,48,.30);overflow:hidden">
...
(function(){
  ...
  function canAccess(k){if(!k||typeof k!=='object'||isClosed(k))return false;var d=selectedDept();if(d&&kDept(k)!==d)return false;try{if(window._fbRole==='kpi_owner'||window._fbRole==='platform_owner'){var a=window._fbAssignedKpis;if(Array.isArray(a)&&a.length&&a.indexOf(code(k))<0)return false;}}catch(_){}return true;}
