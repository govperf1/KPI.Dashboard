...
function switchTab(id, el) {
  ...
  if (typeof renderCurrent === 'function') renderCurrent();
  if (typeof updateChips === 'function') updateChips();
  try{if(window._fbUser&&typeof addAudit==='function'){var names={exec:'Executive Command',dept:'Departments',registry:'KPI Register',accountability:'Accountability',advisory:'Records Request & Review Center'};addAudit('PAGE_VIEW','Opened page: '+(names[id]||id));}}catch(_){}
}
