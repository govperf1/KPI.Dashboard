...
(function(){
  ...
  window._advSubmitConsultation=async function(){
    ...
    try{
      ...
      submitted=true;closeModal();currentView='requests';await loadRecords();showSubmitSuccess(result.code||result.id||'',result.warning||'');
    }catch(e){
